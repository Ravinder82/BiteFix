                ...
                return (
                  ...
                  >
                    ...
                    <View style={{
                      ...
                      {(() => {
                        const hasHidden = item.hasHiddenSugars === true;
                        const count = item.hiddenSugarCount ?? 0;
                        return (
                          <View style={{
                            flexDirection: 'row',
                            alignItems: 'center',
                            gap: 4,
                            backgroundColor: hasHidden ? 'rgba(255, 149, 0, 0.12)' : 'rgba(52, 199, 89, 0.12)',
                            paddingHorizontal: 6,
                            paddingVertical: 2,
                            borderRadius: 6,
                            marginTop: 4,
                          }}>
                            <View style={{ width: 4, height: 4, borderRadius: 2, backgroundColor: hasHidden ? '#FF9500' : '#34C759' }} />
                            <Text style={{
